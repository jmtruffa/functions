...
### Beta version. Need to be running on featureParity branch in github.com/jmtruffa/yields
...
getYields2 = function(letras, settlementDate, precios, initialFee = 0, endingFee = 0, endpoint = "yield") {
